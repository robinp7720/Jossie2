...
export const useChat = () => {
  ...
  }, [apiConfig, canConnect, isSending, pendingFileIds, isStreaming, activeConversationId, setStatusMessage, setActiveConversationId, refreshConversations, addActivity, ensurePendingAssistant]);
